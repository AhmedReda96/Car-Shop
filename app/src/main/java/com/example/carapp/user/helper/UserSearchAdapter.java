...
public class UserSearchAdapter extends RecyclerView.Adapter<UserSearchAdapter.ViewHolder> {
    private SearchProductItemModelBinding binding;
    private Context context;
    private List<ProductEntity> productEntities;
    private String cars;
    private TestLogin testLogin;

    public UserSearchAdapter(List<ProductEntity> productEntityList, Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        binding = DataBindingUtil.inflate(LayoutInflater.from(parent.getContext()),
                R.layout.search_product_item_model, parent, false);

        return new UserSearchAdapter.ViewHolder(binding);
    }
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        SearchProductItemModelBinding binding;

        public ViewHolder(@NonNull SearchProductItemModelBinding binding) {
